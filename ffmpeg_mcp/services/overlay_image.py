...
def overlay_image(
    ...
    if duration is not None:
        ...
        if start_time + duration > video_duration:
            ...
            return build_exception_message(error_type=ValueError, message="Duration for overlay cannot be greater than the video duration") 
